...
const ContextMenu = ({ content, children }) => {
    ...
    const event = {
        ...
        viewSource: () => {
            window.open("https://github.com/thendra-s/thendra-portfolio", "_blank");
        }
    };
    ...
    return (
        <>
            <div
                ...
                className="context-menu absolute bg-[#f8f8f8] dark:bg-[#080808] cursor-pointer text-white rounded-lg shadow-xl py-2 w-72 divide-y divide-gray-600/10 space-y-2"
            >
                {content(event)}
            </div>
